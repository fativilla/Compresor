...
def compress_images_in_folder(folder_path, output_folder, quality=50, progress_var=None, progress_bar=None):
...
def select_folder_and_compress():
    ...
    folder_path = filedialog.askdirectory(title="Selecciona la carpeta con las imágenes")
    ...
    if folder_path:
        ...
        compress_images_in_folder(folder_path, output_folder, quality=50, progress_var=progress_var, progress_bar=progress_bar)
        progress_window.destroy()
        messagebox.showinfo("Éxito", f"Todas las imágenes han sido comprimidas y guardadas en {output_folder}.")
    else:
